  ...
  return (
    <footer className="bg-slate-900 text-slate-200">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4 text-white">{t('footer_more_links')}</h3>
             <ul className="space-y-2">
              <li><Link href="/events" className="text-sm hover:text-primary transition-colors">{t('nav_events')}</Link></li>
        ...
        <div className="border-t border-slate-700 mt-8 pt-6 text-sm text-center space-y-2">
          <p>© 2026 National Ex-Servicemen Party</p>
          <p>
            <Link href="/policies/privacy" className="hover:text-primary">Privacy Policy</Link>
            {' | '}
            <Link href="/policies/terms" className="hover:text-primary">Terms</Link>
          </p>
          <p>
            Developed &amp; Managed by{' '}
            <a
              href="https://madappscreator.in/"
              target="_blank"
